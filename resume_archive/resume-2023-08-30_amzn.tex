...
\resumeSubSectionStart
    ...
    \resumeItemListStart
        \resumeItem{Added universal computer-vision-based insights (e.g. anomaly detection) to a universal device-management system by developing a system for converting images gathered from security cameras to TensorFlow data structures}
