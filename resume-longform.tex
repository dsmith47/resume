...
\resumeSubSectionStart
    ...
    \resumeItemListStart
        \resumeItem{Added universal computer-vision-based insights (e.g. anomaly detection) to universal device-management system by developing a system for converting images gathered from security cameras to TensorFlow-compatible structures}
    ...
    \resumeItemListStart
        ...
        \resumeItem{Implemented specified UX as Android application in Java}
...
\resumeSubSectionStart
    ...
    \resumeSkillList{Programming Tools}{Version Control (Git, Mercurial, Perforce), Amazon Web Services (AWS), Google Cloud Product (GCP)}
